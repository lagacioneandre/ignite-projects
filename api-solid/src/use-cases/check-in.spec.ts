...
import { MaxNumberOfCheckInsError } from './errors/max-numer-of-check-ins-error';
...
describe('Check-in Use Case', () => {
    ...
    it('should not be able to check in on distant gym', async () => {
        gymsRepository.items.push({
            ...
            description: '',
            phone: '',
            latitude: new Decimal(-21.7966747),
            longitude: new Decimal(-50.87399),
        });
        ...
        await expect(() => {
            sut.execute({
                gymId: 'gym-02',
                userId: 'user01',
                userLatitude: -21.7755054,
                userLongitude: -50.6129958,
            })
